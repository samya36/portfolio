...
<html lang="zh-CN" class="scroll-smooth">
  <head>
    ...
    <title>Yan Meihong | AI Ops × Product × Engineering</title>
    ...
    <script>
      tailwind.config = {
        theme: {
          extend: {
            colors: {
              bg: { darkest: '#ffffff', dark: '#f7f8fa', card: '#ffffff' },
              accent: { DEFAULT: '#2563eb', light: '#3b82f6', glow: 'rgba(37,99,235,0.08)' },
    ...
    <\/script>
    <style>
      body { background-color: #ffffff; color: #111827; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Noto Sans SC", sans-serif; -webkit-font-smoothing: antialiased; }
      ...
      .card-glow:hover { box-shadow: 0 4px 24px rgba(37,99,235,0.1); }
